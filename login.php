                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-signin p-4 bg-white rounded shadow">
                            <form>
                                <a href="/"><img style="width:150px !important" src="https://vreestrsro.ru/design/ec/assets/images/logo-dark.png" class="avatar mb-4 d-block mx-auto" alt=""></a>
                                <h5 class="mb-3 text-center">Войти в админ панель</h5>
                                ...
                                <p class="mb-0 text-muted mt-3 text-center">© <script>document.write(new Date().getFullYear())</script> Эксперт центр</p>
                            </form>
                        </div>
                    </div>
                </div>
